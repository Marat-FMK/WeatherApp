...
struct CurrentWeatherView: View {
    ...
    var body: some View {
        ...
        VStack(spacing: 10) {
            ...
            // // TEMP
            TemperatureStack(temperature: currentWeather.temp_c ?? 0, selectedScale: selectedScale, selectScale: selectScale)
...
#Preview {
    CurrentWeatherView(currentWeather: Current(condition: Condition(text: "Patchy rain nearby", icon: "//cdn.weatherapi.com/weather/64x64/day/176.png"), temp_c: 19, wind_kph: 2, humidity: 69), selectedScale: "Celsius", selectScale: {})
}
